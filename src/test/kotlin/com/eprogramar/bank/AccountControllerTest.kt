...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(Account(name = "Fulano", document = "12345678901", phone = "04111987654321"))
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(Account(name = "Fulano", document = "12345678901", phone = "04111987654321"))
    ...
    fun `test create account`() {
        val account = Account(name = "Fulano", document = "12345678901", phone = "04111987654321")
    ...
    fun `test update account`() {
        val account = accountRepository
            .save(Account(name = "Fulano de Tal", document = "12345678901", phone = "04111987654321"))
            .copy(name = "Updated")
        val json = ObjectMapper().writeValueAsString(account)
        mockMvc.perform(
    ...
    fun `test delete account`() {
        val account = accountRepository
            .save(Account(name = "Fulano", document = "12345678901", phone = "04111987654321"))
    ...
    fun `test create account validation error empty name`() {
        val account = Account(name = "", document = "12345678901", phone = "04111987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
    ...
    fun `test create account validation error name should be 5 character`() {
        val account = Account(name = "test", document = "12345678901", phone = "04111987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
    ...
    fun `test create account validation error empty document`() {
        val account = Account(name = "Fulano", document = "", phone = "04111987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
    ...
    fun `test create account validation error document should be 11 character`() {
        val account = Account(name = "Fulano", document = "123", phone = "04111987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
    ...
    fun `test create account validation error empty phone`() {
        val account = Account(name = "Fulano", document = "12345678901", phone = "")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
    ...
    fun `test create account validation error phone should be 11 character`() {
        val account = Account(name = "Fulano", document = "12345678901", phone = "987654321")
        val json = ObjectMapper().writeValueAsString(account)
        accountRepository.deleteAll()
        mockMvc.perform(
            MockMvcRequestBuilders.post("/accounts")
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("\$.message").isString)
            .andExpect(MockMvcResultMatchers.jsonPath("\$.statusCode").value(400))
            .andExpect(MockMvcResultMatchers.jsonPath("\$.message").value("[phone] deve ter no minimo 11 caracteres!"))
            .andDo(MockMvcResultHandlers.print())
    }
